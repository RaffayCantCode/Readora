...
import { Home, BookOpen, Clock, Bookmark, Settings, BookMarked, UploadCloud } from "lucide-react";
    ...
    <>
      ...
      >
        ...
        <nav className="flex flex-col gap-3">
          ...
          {/* Global Import Book Trigger Button */}
          <div className="relative group border-t pt-3" style={{ borderColor: "var(--border-subtle)" }}>
            <button
              onClick={() => setShowImportModal(true)}
              className="flex h-11 w-11 items-center justify-center rounded-2xl transition-all hover:scale-110 shadow-sm"
              style={{
